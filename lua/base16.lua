...
local function apply_base16_theme(theme, use_256_colorspace)
	...
	highlight("javaOperator",     theme.base0D, nil, cterm0D, nil, nil, nil)
        ...
        highlight('TSPunctDelimiter',     theme.base0F, nil, cterm0F, nil, nil, nil)
        highlight('TSPunctBracket',       theme.base0F, nil, cterm0F, nil, nil, nil)
        highlight('TSPunctSpecial',       theme.base0F, nil, cterm0E, nil, nil, nil)
        highlight('TSConstant',           theme.base09, nil, cterm09, nil, nil, nil)
        ...
        highlight('TSNumber',             theme.base09, nil, cterm09, nil, nil, nil)
        highlight('TSBoolean',            theme.base09, nil, cterm09, nil, nil, nil)
        highlight('TSFloat',              theme.base09, nil, cterm09, nil, nil, nil)
        ...
        highlight('TSField',              theme.base08, nil, cterm08, nil, "none", nil)
        ...
        highlight('TSOperator',           theme.base05, nil, cterm05, nil, "none", nil)
        ...
        highlight('TSType',               theme.base0A, nil, cterm0A, nil, "none", nil)
        highlight('TSTypeBuiltin',        theme.base0A, nil, cterm0A, nil, "none", nil)
        ...
        highlight('TSStrong',             theme.base05, theme.base00, cterm05, cterm00, "bold", nil)
        highlight('TSEmphasis',           theme.base05, theme.base00, cterm05, cterm00, "italic", nil)
